    ...
    <div style={{ paddingBlock: '3rem 5rem' }}>
      <div className="container" style={{ maxWidth: '680px' }}>
        ...
        <section style={{ marginBottom: '2.75rem', paddingTop: '2rem', borderTop: '1px solid var(--color-border)' }}>
          ...
          <p style={{ fontSize: '0.9rem', color: 'var(--color-ink-muted)', lineHeight: 1.75, marginTop: '0.875rem' }}>
            Initially, this will require technical comfort — running a local model takes setup. But the
            intention is to simplify the experience until it is accessible to anyone who wants to take
            their inner life seriously.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '2.75rem', paddingTop: '2rem', borderTop: '1px solid var(--color-border)' }}>
          ...
          <p style={{ fontSize: '0.9rem', color: 'var(--color-ink-muted)', lineHeight: 1.75 }}>
            The node content in the Registry is generated by Claude (Anthropic) and reviewed by a mental
          ...
          <p style={{ fontSize: '0.9rem', color: 'var(--color-ink-muted)', lineHeight: 1.75, marginTop: '0.875rem' }}>
            ...
            trained professional or a crisis service in your country.
          </p>
        </section>
